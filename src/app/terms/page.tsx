    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-8 py-48 sm:py-72">
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8 sm:mb-16">
            <h2 className="text-base sm:text-xl font-semibold mb-2">Service Description</h2>
            <p className="text-sm sm:text-base mb-4">
          ...
          <section className="mb-8 sm:mb-16">
            <h2 className="text-base sm:text-xl font-semibold mb-2">Brand Listings and Content</h2>
            <p className="text-sm sm:text-base mb-4">
          ...
          <section className="mb-8 sm:mb-16">
            <h2 className="text-base sm:text-xl font-semibold mb-2">Brand Rights and Responsibilities</h2>
            <p className="text-sm sm:text-base mb-4">
            ...
            <h3 className="text-sm sm:text-base font-semibold mb-3">Brand Rights</h3>
          ...
          <section className="mb-8 sm:mb-16">
            <h2 className="text-base sm:text-xl font-semibold mb-2">User Submissions</h2>
            <p className="text-sm sm:text-base mb-4">
          ...
          <section className="mb-8 sm:mb-16">
            <h2 className="text-base sm:text-xl font-semibold mb-2">Acceptable Use</h2>
            <p className="text-sm sm:text-base mb-4">
          ...
          <section className="mb-8 sm:mb-16">
            <h2 className="text-base sm:text-xl font-semibold mb-2">Disclaimers and Liability</h2>
            <p className="text-sm sm:text-base mb-4">
          ...
          <section className="mb-8 sm:mb-16">
            <h2 className="text-base sm:text-xl font-semibold mb-2">Changes to Terms</h2>
            <p className="text-sm sm:text-base mb-4">
