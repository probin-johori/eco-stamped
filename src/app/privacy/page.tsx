    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-8 py-72">
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-16">
            <h2 className="text-xl font-semibold mb-2">Information We Collect and Use</h2>
            
            <h3 className="text-base font-semibold mb-3">1. Brand Directory Information</h3>
            <p className="mb-4">
              ...
              ranges, and founding history. We source this information from public company websites, 
              social media profiles, media coverage, and direct brand submissions.
            </p>

            <h3 className="text-base font-semibold mb-3">2. Brand Profile Components</h3>
          ...
          <section className="mb-16">
            <h2 className="text-xl font-semibold mb-2">User-Submitted Information</h2>
            <p className="mb-4">
